...
const NewsLatterBox = () => {
  ...
  return (
    ...
    <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
      Ou, se preferir nos chame pelos seguintes pontos:
    </h3>
    ...
    <div className="mt-8">
      <ul className="space-y-4">
        <li className="flex items-center">
          ...
          <a href="mailto:contato@empresa.com" className="text-lg text-body-color dark:text-body-color-dark">contato@empresa.com</a>
        </li>
        <li className="flex items-center">
          <svg
            className="mr-3 h-6 w-6 text-blue-600"
          ...
          <a href="tel:+11234567890" className="text-lg text-body-color dark:text-body-color-dark">(11) 2345-6789</a>
        </li>
        <li className="flex items-center">
          <svg
          ...
          <a href="https://wa.me/11234567890" className="text-lg text-body-color dark:text-body-color-dark">WhatsApp: (11) 2345-6789</a>
        </li>
      </ul>
    </div>
    <p className="mt-11 mb-8 border-t border-body-color border-opacity-25 pt-8 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
      Comece o seu orçamento agora! 
    </p>
    <a
